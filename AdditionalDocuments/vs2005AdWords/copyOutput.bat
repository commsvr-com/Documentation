...
copy "%DXROOT%\Presentation\vs2005AdWords\icons\*" Output\icons
copy "%DXROOT%\Presentation\vs2005AdWords\scripts\*" Output\scripts
copy "%DXROOT%\Presentation\vs2005AdWords\styles\*" Output\styles
